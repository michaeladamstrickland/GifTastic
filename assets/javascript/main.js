var topics = ['dogs', 'bill murray', 'disney', 'space', 'starwars', 'workout', 'animals'];
...
function addGif() {
    $('button').on('click', function() {
        ...
        var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + p + "&api_key=fcrlfl2pSHUG2fIdHbFjitchq4GzJ1KZ&limit=10";
